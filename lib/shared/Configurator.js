...
class Configurator {
  ...
  _makeButton() {
    if (this.options.showButton === true) {
      ...
      generateButton.onmouseover = () => {generateButton.className = 'timeline-configuration timeline-config-button hover';};
      generateButton.onmouseout =  () => {generateButton.className = 'timeline-configuration timeline-config-button';};
