...
class TimeStep {
  ...
  getClassName() {
    ...
    function currentWeek(date) {
      return date.isSame(Date.now(), 'week') ? ' timeline-current-week' : '';
    }
    ...
    function currentMonth(date) {
      return date.isSame(Date.now(), 'month') ? ' timeline-current-month' : '';
    }
    ...
    function currentYear(date) {
      return date.isSame(Date.now(), 'year') ? ' timeline-current-year' : '';
    }
