 ...
 */
  ...
  _onDragStartAddItem(event) {
    ...
    const frameRect = util.getAbsoluteRect(this.dom.frame);
  ...
  _onDrag(event) {
    ...
    if (this.popup != null && this.options.showTooltips && !this.popup.hidden) {
      ...
      const containerRect = util.getAbsoluteRect(container);
      ...
      if (this.groupsData instanceof DataView) {
        groupsData = this.groupsData.getDataSet()
          ...
          if (group && group.height != this.groupTouchParams.group.height) {
              ...
              const targetGroup = util.getAbsoluteRect(group.dom.foreground);
  ...
  groupFromTarget(event) {
    ...
    for (let i = 0; i < groupIds.length; i++) {
      ...
      const foregroundRect = util.getAbsoluteRect(foreground)
