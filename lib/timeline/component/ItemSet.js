 ...
 */
  ...
  _orderGroups() {
    ...
    if (this.groupsData) {
	  ...
	  L.debug("_orderGroups, before _orderNestedGroups: " + groupIds);
	  L.debug("_orderGroups, before _orderNestedGroups: this.groupIds == " + this.groupIds);

      groupIds = this._orderNestedGroups(groupIds);
	  
	  L.debug("_orderGroups, after _orderNestedGroups: " + groupIds);
	  L.debug("_orderGroups, after _orderNestedGroups: this.groupIds == " + this.groupIds);
	  L.debug("New order: " + groupIds + " Old Order: " + this.groupIds);
  ...
  _onGroupClick(event) {
	...
	this.markDirty({restackGroups : true});
  }
