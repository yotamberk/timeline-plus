 ...
 */
  ...
  _repaintMinorLine(left, width, orientation, className) {
    ...
    line.className = `timeline-grid ${this.options.rtl ?  'timeline-vertical-rtl' : 'timeline-vertical'} timeline-minor ${className}`;
  ...
  _repaintMajorLine(left, width, orientation, className) {
    ...
    this._setXY(line, x, y);
    line.className = `timeline-grid ${this.options.rtl ?  'timeline-vertical-rtl' : 'timeline-vertical'} timeline-major ${className}`;
