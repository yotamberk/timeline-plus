 ...
 */
  ...
  repositionX() {
    ...
    if (this.options.rtl) {
      ...
      // reposition point
      this.dom.point.style.transform = `translateX(${this.right * -1})px`;
    } else {
      this.left = start - this.props.dot.width;

      // reposition point
      this.dom.point.style.transform = `translateX(${this.left}px)`;
    }
  }
  ...
  repositionY() {
    ...
    if (orientation == 'top') {
      point.style.transform = `translateY(${this.top}px)`;
    }
    else {
      point.style.transform = `translateY(${this.parent.height - this.top - this.height}px)`;
    }
  }
