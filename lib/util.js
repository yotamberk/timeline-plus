  ...
  switch (type) {
    ...
    case 'Date':
      ...
      if (exports.isString(object)) {
        ...
        throw new Error(
          `Cannot convert object of type ${exports.getType(object)} to type Date`);
      }
    ...
    case 'ISODate':
      if (exports.isNumber(object)) {
        ...
        throw new Error(
          `Cannot convert object of type ${exports.getType(object)} to type ISODate`);
      }
    ...
    case 'ASPDate':
      if (exports.isNumber(object)) {
        ...
        throw new Error(
          `Cannot convert object of type ${exports.getType(object)} to type ASPDate`);
      }
 ...
 */
exports.option.asBoolean = (value, defaultValue) => {
 ...
 */
exports.option.asNumber = (value, defaultValue) => {
  if (typeof value == 'function') {
    value = value();
  }
 ...
 * @returns {String} str
 */
exports.option.asString = (value, defaultValue) => {
  if (typeof value == 'function') {
    value = value();
  }
 ...
 * @returns {String} size
 */
exports.option.asSize = (value, defaultValue) => {
  if (typeof value == 'function') {
    value = value();
  }
 ...
 */
exports.option.asElement = (value, defaultValue) => {
  if (typeof value == 'function') {
    value = value();
  }
...
export function insertSort(a, compare) {
  for (let i = 0; i < a.length; i++) {
    const k = a[i];
    for (let j = i; j > 0 && compare(k,a[j - 1])<0; j--) {
      a[j] = a[j - 1];
    }
    a[j] = k;
  }
